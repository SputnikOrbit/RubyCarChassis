...
//     //because the gimbal is in front of chassis, when chassis rotates, wheel 0 and wheel 1 should be slower and wheel 2 and wheel 3 should be faster
//     //旋转的时候， 由于云台靠前，所以是前面两轮 0 ，1 旋转的速度变慢， 后面两轮 2,3 旋转的速度变快
//     wheel_speed[0] = -vx_set / SQRT2 + vy_set / SQRT2 - MOTOR_DISTANCE_TO_CENTER * wz_set;
//     wheel_speed[1] = vx_set / SQRT2 - vy_set / SQRT2 - MOTOR_DISTANCE_TO_CENTER * wz_set;
//     wheel_speed[2] = -vx_set / SQRT2 + vy_set / SQRT2 - MOTOR_DISTANCE_TO_CENTER * wz_set;
//     wheel_speed[3] = vx_set / SQRT2 - vy_set / SQRT2 -  MOTOR_DISTANCE_TO_CENTER * wz_set;
// } //SPUTNIK 这里突然存在巨大问题，原因未知，暂时使用下面的函数
